        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h1 class="foglalas_cim">Foglalás</h1>
                    <br>
                    ...
                    <form action="foglalas" method="POST">
                        ...
                        <input class="block mt-1 w-full" id="date" value="2022-06-01T08:30" name="date" type="datetime-local" required pattern="\d{4}-\d{2}-\d{2}">
                        <br>
                        <br>
                        <x-button class="ml-4" name="Foglalás" dusk="foglalas">
                            {{ __('Foglalás') }}
                        </x-button>
                    </form>
                </div>
